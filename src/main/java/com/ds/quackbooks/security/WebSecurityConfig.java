package com.ds.quackbooks.security;
...
import com.ds.quackbooks.security.services.UserDetailsServiceImp;
...
import com.ds.quackbooks.security.jwt.AuthEntryPointJwt;
import com.ds.quackbooks.security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig {
    ...
    public CommandLineRunner initData(RoleRepository roleRepository, UserRepository userRepository, PasswordEncoder passwordEncoder) {
        return args -> {
            ...
            userRepository.findByEmail("seller1@example.com").ifPresent(seller -> {
